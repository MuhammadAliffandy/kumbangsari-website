...
import { addGallery, editGallery } from '@/app/api/repository/galleryRepository';


const AppModalGallery = (props) => {

    const { push } = useRouter()

    const data = useSelector((state) => state.gallery.value)
    ...
    const handleUpdateImage = async () => {
        try {
            ...
            if(res.status == 'OK'){
                toast.success('Edit Galeri Sukses')
            }
        ...
        >
            ...
            <motion.div 
                ...
                <Box className = 'flex justify-between'>
                    <p className = 'text-[18px] font-bold text-black' >Galeri Manajemen</p>
...
export default AppModalGallery;